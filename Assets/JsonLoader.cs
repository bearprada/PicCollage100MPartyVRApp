...
public class JsonLoader : MonoBehaviour {
	private string url = "http://party-collage.herokuapp.com/api/feeds/latest";
...
//	private string[] mockUrls = {
//		"http://pic-collage.com:80/api/assets?key=cfad601d38d4a673b84a95cbf5fc051b&collage_id=123479840&size=100x100",
//		"http://pic-collage.com/api/assets?key=661ba5ac9068166cbb658c48184e1c44",
//		"http://pic-collage.com:80/api/assets?key=62fb71f2cc942ee96fdd6d40d1d7d2de&collage_id=123462376&size=100x100",
//		"http://pic-collage.com/api/assets?key=7d6897b36b6ce5b00c3d7121e533eb96",
//		"http://pic-collage.com/api/assets?key=62382fa6b015f4aa9f75aa7af03c6ba6",
//		"http://pic-collage.com:80/api/assets?key=68ef45a1e91d12a0d0892788e70aa7e9&collage_id=123449800&size=100x100",
//		"http://pic-collage.com/api/assets?key=637f13d00e247e96293e7b67d7e45765",
//		"http://pic-collage.com:80/api/assets?key=f61eaa2974c79f630a27d2e786223089&collage_id=123545131&size=100x100",
//		"http://pic-collage.com/api/assets?key=8b17d458430e90702569557ab3e1df9c",
//		"http://pic-collage.com:80/api/assets?key=344ae1876694976cd9a1539c22a2a610&collage_id=77527918&size=100x100",
//		"http://pic-collage.com:80/api/assets?key=e9369e7e222de757f86c0a2bbe4d290c&collage_id=29582384&size=100x100",
//		"http://pic-collage.com:80/api/assets?key=34967ed51bb91e96011500087be2d8e9&collage_id=63592121&size=100x100",
//		"http://pic-collage.com/api/assets?key=3eaf6fb194035b97f68a5cef0151ce05",
//		"http://pic-collage.com/api/assets?key=21d344bdca1a3fe4c79d3fd090b6febd",
//		"http://pic-collage.com/api/assets?key=7373589cb0246c852bc8c862abda0451",
//		"http://pic-collage.com:80/api/assets?key=cfad601d38d4a673b84a95cbf5fc051b&collage_id=123479840&size=100x100",
//		"http://pic-collage.com/api/assets?key=661ba5ac9068166cbb658c48184e1c44",
//		"http://pic-collage.com:80/api/assets?key=62fb71f2cc942ee96fdd6d40d1d7d2de&collage_id=123462376&size=100x100",
//		"http://pic-collage.com/api/assets?key=7d6897b36b6ce5b00c3d7121e533eb96",
...
//		"http://pic-collage.com/api/assets?key=21d344bdca1a3fe4c79d3fd090b6febd"};
	...
	public PicPartyNetworkImage[] images;

	void Start () {
		// StartCoroutine (LoadHottestList ());
		int size = images.Length;
		int mockImageIdx = 0;
		for (int i = 0 ; i < size ; i++) {
			PicPartyNetworkImage img = images[i];
			// Debug.LogError (">>>>>> setting mock url to image at " + i);
			string url = mockUrls[mockImageIdx++];
			img.setImageUrl(url, 0);
		}
	}
	...
	IEnumerator LoadHottestList() {
		// Start a download of the given URL
		WWW www = new WWW(url, GetBytes("{}"));
		...
		foreach(JSONObject obj in json.list){
			for(int i = 0; i < obj.list.Count ; i++){
				...
				if (key == "image_url") {
					string u = obj.list[i].str.Replace("photos", "resized");
					// Debug.LogError (">>>>>> setting image at " + idx);
					images[idx++].setImageUrl(u, 0);
				}
			}
			if (idx == 10) {
				break;
